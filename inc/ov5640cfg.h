...
{                 
	{0x4300, 0x30}, // YUV 422, YUYV 					RGB<->JPG
	{0x501f, 0x00}, // YUV 422 							RGB<->JPG
	// Input clock = 24Mhz
	{0x3035, 0x21}, // PLL  
	{0x3036, 0x95}, // PLL 
	{0x3c07, 0x07}, // lightmeter 1 threshold[7:0] 
	{0x3820, 0x46}, // flip
	{0x3821, 0x20}, // mirror						    RGB<->JPG		 
	{0x3814, 0x11}, // timing X inc 					RGB<->JPG
	{0x3815, 0x11}, // timing Y inc 					RGB<->JPG
	{0x3800, 0x00}, // HS 
	{0x3801, 0x00}, // HS 
	{0x3802, 0x00}, // VS 
	{0x3803, 0x00}, // VS 
	...
	{0x380c, 0x0b}, // HTS 		//							RGB<->JPG
	{0x380d, 0x1c}, // HTS 									RGB<->JPG
	{0x380e, 0x07}, // VTS 		//							RGB<->JPG
	{0x380f, 0xb0}, // VTS 									RGB<->JPG
	...
	{0x3002, 0x00}, // enable JFIFO, SFIFO, JPG 			RGB<->JPG
	{0x3006, 0xff}, // enable clock of JPEG2x, JPEG 		RGB<->JPG
...
{      
 ...
 // 	{0x5003, 0x0A}, //draw window
	// {0x501f, 0x02}, //draw window
	// {0x5027, 0x03},
	// {0x5028, 0x00},
	// {0x5029, 0xBE},
	// {0x502A, 0x01},
...
{   
	...
	{0x3a19, 0x7c}, // gain ceiling = 15.5x //0xf8}
	{0x3635, 0x13},
	{0x3636, 0x03},
	{0x3634, 0x40},
	{0x3622, 0x01},
	...
	{0x3c07, 0x07}, // light meter 1 threshold[7:0] //0x08
